...
def main():
    ...
    trainer = pl.Trainer( max_epochs=opt.epochs,accelerator="gpu",devices=[6],strategy="ddp_find_unused_parameters_true",logger=logger,callbacks=[checkpoint_callback])
